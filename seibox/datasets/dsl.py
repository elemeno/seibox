...
def generate_uk_address(seed: int) -> str:
    ...
    streets = ["High Street", "Church Lane", "Park Road", "King's Road", "Queen Street",
               "Market Square", "Victoria Road", "Station Road", "Main Street"]
    cities = ["London", "Manchester", "Birmingham", "Leeds", "Glasgow", "Liverpool",
              "Bristol", "Sheffield", "Edinburgh", "Cardiff"]
    postcodes = ["SW1A 1AA", "M1 1AA", "B1 1AA", "LS1 1AA", "G1 1AA", 
                 "L1 1AA", "BS1 1AA", "S1 1AA", "EH1 1AA", "CF1 1AA"]
    ...
    for match in re.finditer(var_pattern, template):
        ...
        if '(' in var_content:
            ...
            if not re.match(r'^[a-zA-Z_][a-zA-Z0-9_.]*$', var_content):
                ...
                known_builtins = {
                    "email", "phone_e164", "credit_card", "uk_ni", 
                    "address_uk", "lorem_sentence", "date_iso"
                }
