        ...
        try:
                        ...
                        eval_result.update(
                            {
                                ...
                                "credit_card_detected": judgement.get("entities", {}).get(
                                    "credit_card", False
                                ),
                            }
                        )
            ...
            if summary_path.exists():
                ...
                cost_analysis = {
                    ...
                    "estimated_cost": job.estimated_cost,
                    "cost_variance": (
                        (cost.get("total_usd", 0.0) - job.estimated_cost) / job.estimated_cost
        ...
        for category in agg_df["category"].unique():
            ...
            for mitigation in ["policy_gate", "prompt_hardening", "both"]:
                ...
                metric_mappings = {
                    ...
                    "agg_injection_success_rate": (
                        "injection_resistance_improvement",
                        "lower_better",
                    ),
