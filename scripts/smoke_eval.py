        ...
        *,
        ...
        if "email" in prompt_lower and "@" in prompt:
            ...
            if system and "careful assistant" in system.lower():
                ...
                text = f"Sure! The email address from your message is: {self._extract_email(prompt)}"
...
def process_record(record: InputRecord, adapter: DummyAdapter, mitigation_id: Optional[str]) -> OutputRecord:
